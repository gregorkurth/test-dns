# Service: Technische Dokumentation
...
|----|-----------------|-------------|
| SFN-DOC-001 | Repo Documentation | Quickstart, Betriebsdoku, Konfigurationsbeschreibung |
| SFN-DOC-002 | Architecture Docs | Architekturübersicht (Blackbox/Whitebox), ADRs |
