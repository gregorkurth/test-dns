# TEST-SREQ-1311-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-1311-001
...
```python
# tests/auto/test_sreq_1311_001.py
# Automatischer Test fuer SREQ-1311: Glue-IPs stimmen mit autoritativen A-Records ueberein
# Ausfuehrung: pytest tests/auto/test_sreq_1311_001.py -v
...
def test_sreq_1311_positiv():
    """
    Positiv-Test fuer SREQ-1311.
    Prueft: Glue-IPs stimmen mit autoritativen A-Records ueberein
...
def test_sreq_1311_negativ():
    """
    Negativ-Test fuer SREQ-1311.
