# TEST-SREQ-379-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-379-001
...
```python
# tests/auto/test_sreq_379_001.py
# Automatischer Test fuer SREQ-379: Unsignierte Zonen koennen delegiert werden
# Ausfuehrung: pytest tests/auto/test_sreq_379_001.py -v
...
def test_sreq_379_positiv():
    """
    Positiv-Test fuer SREQ-379.
    Prueft: Unsignierte Zonen koennen delegiert werden
...
def test_sreq_379_negativ():
    """
    Negativ-Test fuer SREQ-379.
