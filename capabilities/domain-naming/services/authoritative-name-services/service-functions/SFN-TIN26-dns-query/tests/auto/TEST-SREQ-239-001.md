# TEST-SREQ-239-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-239-001
...
```python
# tests/auto/test_sreq_239_001.py
# Automatischer Test fuer SREQ-239: Reverse-Zone mit PTR-Records wird korrekt bedient
# Ausfuehrung: pytest tests/auto/test_sreq_239_001.py -v
...
def test_sreq_239_positiv():
    """
    Positiv-Test fuer SREQ-239.
    Prueft: Reverse-Zone mit PTR-Records wird korrekt bedient
...
def test_sreq_239_negativ():
    """
    Negativ-Test fuer SREQ-239.
