# TEST-SREQ-616-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-616-001
...
```python
# tests/auto/test_sreq_616_001.py
# Automatischer Test fuer SREQ-616: Rekursive Queries werden mit REFUSED abgewiesen
# Ausfuehrung: pytest tests/auto/test_sreq_616_001.py -v
...
def test_sreq_616_positiv():
    """
    Positiv-Test fuer SREQ-616.
    Prueft: Rekursive Queries werden mit REFUSED abgewiesen
...
def test_sreq_616_negativ():
    """
    Negativ-Test fuer SREQ-616.
