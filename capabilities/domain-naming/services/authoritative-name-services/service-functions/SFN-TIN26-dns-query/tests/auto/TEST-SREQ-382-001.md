# TEST-SREQ-382-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-382-001
...
```python
# tests/auto/test_sreq_382_001.py
# Automatischer Test fuer SREQ-382: Signierte Zonen werden mit RRSIG-Records zurueckgegeben
# Ausfuehrung: pytest tests/auto/test_sreq_382_001.py -v
...
def test_sreq_382_positiv():
    """
    Positiv-Test fuer SREQ-382.
    Prueft: Signierte Zonen werden mit RRSIG-Records zurueckgegeben
...
def test_sreq_382_negativ():
    """
    Negativ-Test fuer SREQ-382.
