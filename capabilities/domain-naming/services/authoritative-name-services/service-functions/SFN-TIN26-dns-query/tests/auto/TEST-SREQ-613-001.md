# TEST-SREQ-613-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-613-001
...
```python
# tests/auto/test_sreq_613_001.py
# Automatischer Test fuer SREQ-613: Zwei unabhaengige Nameserver pro Zone sind konfiguriert
# Ausfuehrung: pytest tests/auto/test_sreq_613_001.py -v
...
def test_sreq_613_positiv():
    """
    Positiv-Test fuer SREQ-613.
    Prueft: Zwei unabhaengige Nameserver pro Zone sind konfiguriert
...
def test_sreq_613_negativ():
    """
    Negativ-Test fuer SREQ-613.
