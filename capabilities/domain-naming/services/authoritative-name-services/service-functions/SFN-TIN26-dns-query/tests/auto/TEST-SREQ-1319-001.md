# TEST-SREQ-1319-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-1319-001
...
```python
# tests/auto/test_sreq_1319_001.py
# Automatischer Test fuer SREQ-1319: DNSKEY in Child-Zone passt zu DS-Record
# Ausfuehrung: pytest tests/auto/test_sreq_1319_001.py -v
...
def test_sreq_1319_positiv():
    """
    Positiv-Test fuer SREQ-1319.
    Prueft: DNSKEY in Child-Zone passt zu DS-Record
...
def test_sreq_1319_negativ():
    """
    Negativ-Test fuer SREQ-1319.
