# TEST-SREQ-1312-001: Automatischer Test

> **Testfall-ID:** TEST-SREQ-1312-001
...
```python
# tests/auto/test_sreq_1312_001.py
# Automatischer Test fuer SREQ-1312: NS-Records stimmen mit Delegation im Parent ueberein
# Ausfuehrung: pytest tests/auto/test_sreq_1312_001.py -v
...
def test_sreq_1312_positiv():
    """
    Positiv-Test fuer SREQ-1312.
    Prueft: NS-Records stimmen mit Delegation im Parent ueberein
...
def test_sreq_1312_negativ():
    """
    Negativ-Test fuer SREQ-1312.
