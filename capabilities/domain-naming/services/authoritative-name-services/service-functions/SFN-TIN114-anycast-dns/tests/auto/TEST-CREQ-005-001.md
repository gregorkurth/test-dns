# TEST-CREQ-005-001: Automatischer Test

> **Testfall-ID:** TEST-CREQ-005-001
...
```python
# tests/auto/test_creq_005_001.py
# root-ns.core.ndp.che ist erreichbar; BGP-Route vorhanden
# Ausfuehrung: pytest tests/auto/test_creq_005_001.py -v
...
def test_creq_005_positiv():
    """
    Prueft: root-ns.core.ndp.che ist erreichbar; BGP-Route vorhanden
    """
