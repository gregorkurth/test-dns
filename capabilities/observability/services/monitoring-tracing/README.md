...
Der Monitoring & Tracing Service umfasst die vollstaendige Instrumentierung der App und des Operators mit OpenTelemetry. Metriken werden im Prometheus-Format exportiert, Logs sind strukturiert (JSON) und Traces werden via OTLP an konfigurierbare Backends gesendet. Die Zielarchitektur fuehrt alle drei Signaltypen nach ClickHouse und nutzt Grafana (ClickHouse-Data-Source) fuer die Auswertung.
...
|----|-----------------|-------------|-------------|-------|
| SFN-OBS-001 | Metrics Export | Prometheus-Metriken unter /metrics, ClickHouse-Weitergabe, DNS-Dashboard-Vorlage | [Requirements](service-functions/SFN-OBS-001-metrics-export/README.md) | 5 Auto, 5 Manuell |
