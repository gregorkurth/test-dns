...
## User Stories
- Als Mission Network Operator möchte ich aus den erfassten Konfigurationsdaten (OBJ-5) mit einem Klick BIND9-konforme Zone-Files generieren, damit ich diese direkt in meinen Nameserver laden kann.
...
- Sonderzeichen in FQDNs → Validierung in OBJ-5 verhindert dies; Generator zeigt Fallback-Fehler
