...
- Zusaetzliche ARCH-Requirements sind im CAP-006-Kontext angelegt: RDTS-610 (Statuslogik), RDTS-611 (Run/Release-Snapshots + OFT-Traceability)
...
Die Sicht beantwortet drei Kernfragen: Was ist aktuell gruen/rot, was wurde nie getestet, und wie ist der Status pro Release und Testlauf.
...
Das Dashboard arbeitet mit drei fachlichen Objekten:
